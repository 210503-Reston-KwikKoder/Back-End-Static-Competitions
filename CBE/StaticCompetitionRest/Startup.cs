...
namespace StaticCompetitionRest
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<StaticCompetitionDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("CBEDB")));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "StaticCompetitionRest", Version = "v1" });
